...
namespace GuardrailTests
{
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            if (args.Length == 2 && args[0] == "--native-xa01-route") return Xa01RouteNativeAcceptance.Run(args[1]);
            if (args.Length == 2 && args[0] == "--native-xa01-failed-workbook") return Xa01RouteNativeAcceptance.RunFailedWorkbook(args[1]);
            ...
            if (args.Length == 2 && args[0] == "--native-xa01-transport-exhausted") return Xa01RouteNativeAcceptance.RunTransportExhausted(args[1]);
            if (args.Length == 2 && args[0] == "--native-xa01-rejected-review") return Xa01RouteNativeAcceptance.RunRejectedReview(args[1]);
            if (args.Length == 2 && args[0] == "--native-xa01-restart-reconcile") return Xa01RouteNativeAcceptance.RunRestartReconcile(args[1]);
            ...
            try
            {
                ...
                Run("Saved decks cannot use chart package fingerprints", AnalysisReviewContractTests.SavedDeckCannotUseChartPackageFingerprint);
                ...
                Run("Encoded slide table rows retain content after one bracket repair", OfficeBootstrapTests.EncodedSlideWithOneTransposedTableRowsBracketKeepsContent);
