...
5. Open the **Test Lab** button in any Scribble pane. Select a case, read its setup, prepare its inputs, then click **Start case**. Confirm that the context is synthetic. The exact prompt is copied to the clipboard. Start the screen recording and add a video marker.
