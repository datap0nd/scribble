...
`--native-xa01-failed-workbook`, `--native-analysis-pilot`,
...
The failed-workbook route is the first D2 negative receipt; the other six
negative paths are next. D3 calibration and D4–D9 remain open.
