...
const MENU_PAGE = "scribble-ask-page";
const MENU_SELECTION = "scribble-ask-selection";
...
async function rebuildContextMenus() {
  try {
    ...
    chrome.contextMenus.create({
      id: MENU_SELECTION,
      title: "Ask Scribble about this selection",
      contexts: ["selection"]
    });
  } catch (error) {
...
function describePageAccessError(error) {
  ...
  return message || "Scribble could not read this page. Click the Scribble toolbar button on the tab and try again.";
}
