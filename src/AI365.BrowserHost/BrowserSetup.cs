...
namespace AI365.BrowserHost
{
    internal static class BrowserSetup
    {
        internal static int Run(string requestedBrowser)
        {
            ...
            {
                MessageBox.Show(
                    "The AI365 browser extension files are missing. " +
                    "Run AI365 Setup again and select Browser extension.",
                    "AI365 browser setup",
            ...
            {
                MessageBox.Show(
                    "AI365 could not open " + browser.DisplayName +
            ...
            MessageBox.Show(
                ...
                (copied
                    ...
                    : string.Empty) +
                "\n\nThis one-time confirmation is required because AI365 is not distributed through a browser store.",
                "Finish AI365 setup in " + browser.DisplayName,
                MessageBoxButtons.OK,
            ...
            out bool canceled)
        {
            ...
            if (edge != null && chrome != null)
            {
                var choice = MessageBox.Show(
                    "Set up AI365 in Microsoft Edge?\n\n" +
